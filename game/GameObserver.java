...
public interface GameObserver {
	 ...
	 * 
	 * @param p
	 *            The coordinates of the field where the extra item has been
	 *            placed.
	 * 
	 */
	...
	/**
	 * This method is called by the GameObservable every time an extra item is
	 * eaten or the time, specified by {@link PacManGame#DURATION_EXTRAITEM} is
	 * lapsed.
	 */
	 ...
	 * 
	 * @param actortype
	 *            The type of the actor that has been set.
	 * 
	 * @param x
	 ...
	 * 
	 * @param actortype
	 *            The type of the actor that has been removed.
	 * 
	 * @param x
